      ...
      <div class="lg:col-span-7 space-y-6">
        ...
        <UiCard title="Логарифмическая регрессия (ваш случай)">
          <div class="space-y-3 text-slate-700 leading-relaxed">
            <p>
              Для каждого маркера строится модель вида:
              <span class="font-mono bg-slate-100 px-2 py-1 rounded-lg">ln(Y) = b0 + b1·V + b2·P + b3·R</span>
            </p>
            <p>
              Коэффициенты интерпретируются как процентный эффект:
              <span class="font-mono bg-slate-100 px-2 py-1 rounded-lg">(exp(b) − 1)·100%</span>.
            </p>
            <p>
              Прогноз в исходных единицах:
              <span class="font-mono bg-slate-100 px-2 py-1 rounded-lg">Y = exp(b0 + b1·V + b2·P + b3·R)</span>.
            </p>
          </div>
        </UiCard>
